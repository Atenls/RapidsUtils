...
Vitals values use a dedicated smooth renderer with [Inter](https://rsms.me/inter/) Medium (weight 500, optical size 14), subset to printable ASCII as **Rapids Vitals**. The font and derived atlases remain under SIL OFL 1.1; see the bundled `assets/rapidsutils/font/ofl_inter.txt`. Digits retain six-pixel tabular advances and approximately seven GUI pixels of visible height. All five styles draw values without a text shadow and center the cap area; style C uses its full nine-pixel HUD area.
